...
const dashboardCardClass = "overflow-hidden border-white/20 bg-white/10 dark:bg-white/5 backdrop-blur-xl shadow-xl shadow-black/5 transition-all duration-200 hover:-translate-y-1 hover:bg-white/15"
const dashboardIconClass = "h-10 w-10 rounded-2xl bg-white/15 border border-white/20 flex items-center justify-center shadow-sm"
...
export function DashboardPage() {
    ...
    return (
        <div className="space-y-6 p-4 md:p-6 max-w-full overflow-x-hidden min-h-screen" style={{backgroundImage:`url(${backhome})`,backgroundSize:`cover`,backgroundPosition:`center`}}>
            {/* Page Title */}
            <div>
                    ...
                    {dashboardData.panels && (
                        <Card className={dashboardCardClass}>
                            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                                ...
                                <div className={dashboardIconClass}><Server className="h-5 w-5 text-purple-500" /></div>
                            </CardHeader>
                            <CardContent>
                    ...
                    {dashboardData.admins && (
                        <Card className={dashboardCardClass}>
                            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                                ...
                                <div className={dashboardIconClass}><Users className="h-5 w-5 text-green-500" /></div>
                            </CardHeader>
                            <CardContent>
                    ...
                    {dashboardData.admins && (
                        <Card className={dashboardCardClass}>
                            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                                ...
                                <div className={dashboardIconClass}><UserX className="h-5 w-5 text-red-500" /></div>
                            </CardHeader>
                            <CardContent>
                ...
                <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
                    <Card className={dashboardCardClass}>
                        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                            ...
                            <div className={dashboardIconClass}><HardDrive className="h-5 w-5 text-indigo-500" /></div>
                        </CardHeader>
                        <CardContent>
                            <div className="text-2xl font-bold">
                    ...
                    <Card className={dashboardCardClass}>
                        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                            ...
                            <div className={dashboardIconClass}><HardDrive className="h-5 w-5 text-pink-500" /></div>
                        </CardHeader>
                        <CardContent>
                            <div className="text-2xl font-bold">
                    ...
                    <Card className={dashboardCardClass}>
                        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                            ...
                            <div className={dashboardIconClass}><Zap className="h-5 w-5 text-orange-500" /></div>
                        </CardHeader>
                        <CardContent>
                ...
                <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
                    ...
                    <Card className={dashboardCardClass}>
                        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                            ...
                            <div className={dashboardIconClass}><Zap className="h-5 w-5 text-yellow-500" /></div>
                        </CardHeader>
                        <CardContent>
                            <div className="text-2xl font-bold">
                    ...
                    <Card className={dashboardCardClass}>
                        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                            ...
                            <div className={dashboardIconClass}><Clock className="h-5 w-5 text-blue-500" /></div>
                        </CardHeader>
                        <CardContent>
                            <div className="text-2xl font-bold">
                    ...
                    <Card className={dashboardCardClass}>
                        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                            ...
                            <div className={dashboardIconClass}><Wifi className="h-5 w-5 text-emerald-500" /></div>
                        </CardHeader>
                        <CardContent>
                    ...
                    <CardHeader className="flex flex-col gap-4">
                        ...
                        <div className="flex flex-col sm:flex-row gap-3">
                            <select
                                ...
                                className="glass-select h-10 w-auto rounded-md border border-white/15 bg-white/10 px-3 text-sm text-white shadow-lg shadow-black/10 backdrop-blur-xl ring-offset-background focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-pink-400/70 focus-visible:ring-offset-0"
                            >
                                <option className="bg-[#10051f] text-white" value="all">All</option>
                                <option className="bg-[#10051f] text-white" value="active">Active</option>
                                <option className="bg-[#10051f] text-white" value="inactive">Inactive</option>
                                <option className="bg-[#10051f] text-white" value="online">Online</option>
                            </select>
                            <div className="relative flex-1 rounded-md border border-white/15 bg-white/10 shadow-lg shadow-black/10 backdrop-blur-xl">
                                ...
                                <Input
                                    ...
                                    className="pl-10 border-0 bg-transparent shadow-none backdrop-blur-0 focus-visible:ring-pink-400/70"
                                />
                            </div>
                        </div>
                    </CardHeader>
                                            ...
                                            <div className="flex items-center gap-3">
                                                ...
                                                <div className="flex items-center gap-2">
                                                    ...
                                                    <select
                                                        ...
                                                        className="glass-select h-8 rounded-md border border-white/15 bg-white/10 px-2 text-sm text-white shadow-lg shadow-black/10 backdrop-blur-xl ring-offset-background focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-pink-400/70 focus-visible:ring-offset-0"
                                                    >
                                                        <option className="bg-[#10051f] text-white" value={5}>5</option>
                                                        <option className="bg-[#10051f] text-white" value={10}>10</option>
                                                        <option className="bg-[#10051f] text-white" value={20}>20</option>
                                                    </select>
                                                </div>
                                            </div>
                ...
                <TableRow className="bg-white/10">
                    <TableCell colSpan={6}>
                        <div className="py-4 space-y-3">
                            {subUrl && user.sub_id && (
                                <div className="p-3 rounded-md border border-white/15 bg-white/10 backdrop-blur-xl overflow-hidden">
...
function MobileUserCard({
    ...
    return (
        <div className="overflow-hidden rounded-2xl border border-white/20 bg-white/10 dark:bg-white/5 backdrop-blur-xl shadow-lg">
            ...
            {/* Expanded View */}
            {isExpanded && (
                <div className="border-t border-white/20 p-3 space-y-3 bg-white/10">
                    {/* Subscription Link */}
                    {subUrl && user.sub_id && (
                        <div className="p-3 rounded-md border border-white/15 bg-white/10 backdrop-blur-xl overflow-hidden">
                            <div className="text-xs text-muted-foreground mb-1">Subscription Link:</div>
