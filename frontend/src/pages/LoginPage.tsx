...
export function LoginPage() {
    ...
    <div className="relative flex min-h-screen items-center justify-center overflow-hidden px-4">
        ...
        <div className="relative z-10 w-full max-w-md">
            ...
            {/* Login Card */}
            <div className="rounded-[28px] border border-red-500/20 bg-[#080b15]/90 p-8 backdrop-blur-xl shadow-[0_0_80px_rgba(255,0,80,.18)]">
                ...
                >
                    ...
                    <div>
                        ...
                        <div className="relative">
                            ...
                            <Input
                                ...
                                className="h-12 border-red-500/20 bg-black/30 pl-10 text-white placeholder:text-zinc-500 focus:border-red-500"
                            />
                        </div>
                    ...
                    <Button
                        ...
                        className="
                            ...
                            via-orange-500
                            to-yellow-500
                            shadow-[0_0_30px_rgba(255,80,80,.35)]
                            transition-all
                            duration-300
                            hover:scale-[1.02]
                        "
