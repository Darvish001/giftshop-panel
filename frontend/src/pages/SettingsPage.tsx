            ...
            <Dialog open={showLogsModal} onOpenChange={setShowLogsModal}>
                <DialogContent className="max-w-2xl max-h-[80vh] overflow-y-auto">
                    ...
                    <div className="space-y-3">
                        ...
                        <div className="rounded-2xl border border-white/20 bg-white/10 p-4 max-h-96 overflow-y-auto backdrop-blur-xl">
                            {logs.length > 0 ? (
                        ...
                        {news.length > 0 ? (
                            <div className="space-y-2 max-h-96 overflow-y-auto">
                                {news.map((item) => (
                                    <div
                                        key={item.id}
                                        className="p-3 rounded-2xl border border-white/20 bg-white/10 backdrop-blur-xl flex items-start justify-between gap-3"
                                    >
